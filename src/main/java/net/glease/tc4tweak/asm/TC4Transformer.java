...
public class TC4Transformer implements IClassTransformer {
    ...
    private final Map<String, TransformerFactory> transformers = ImmutableMap.<String, TransformerFactory>builder()
            ...
            .put("thaumcraft.api.visnet.TileVisNode", new TransformerFactory(TileVisNodeVisitor::new))
            ...
            .put("thaumcraft.common.items.equipment.ItemElementalShovel", new TransformerFactory(ItemElementalShovelVisitor::new))
            .put("thaumcraft.common.items.ItemEssence", new TransformerFactory(ItemEssenceVisitor::new))
            .put("thaumcraft.common.items.wands.ItemWandCasting", new TransformerFactory(ItemWandCastingVisitor::new))
            ...
            .put("thaumcraft.common.lib.research.ResearchManager", new TransformerFactory(ResearchManagerVisitor::new))
            ...
            .put("thaumcraft.common.lib.world.dim.GenCommon", new TransformerFactory(GenCommonVisitor::new))
